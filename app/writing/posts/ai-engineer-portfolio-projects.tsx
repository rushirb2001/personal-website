...
export default function Post() {
  return (
    <>
      ...
      <h2>The three reasons portfolios get skipped</h2>
      ...
      <p>
        The fix is unglamorous and takes an afternoon: a GitHub Actions workflow that runs your
        test suite on every push, and a benchmark script whose output you commit as a file. Now
        the green check next to your latest commit is doing the arguing for you.
      </p>

      <h3>2. Breadth instead of depth</h3>
      <p>
        Eight shallow projects read as eight abandoned projects. They also produce an interview
        you cannot win: the interviewer picks one, asks &ldquo;why did you chunk at 512
        tokens?&rdquo;, and there is no answer because the number came from a tutorial.
      </p>
      <p>
      ...
      <p>
        ...
        someone else&rsquo;s messy systems under a deadline. Candidates routinely build for the
        job title they find exciting rather than the one they are applying to.
      </p>

      <h2>What each role is actually screening for</h2>
      ...
      <p>
        Screening for: do you know whether your system works. In 2026 the honest differentiator
        is evaluation, not model choice, because everyone has access to the same models.
      </p>
      <ul>
        <li>
      ...
      <h2>The five things a strong repo has</h2>
      ...
      <ol>
        ...
        <li>
          <strong>A design document.</strong> Two pages: what you chose, what you rejected, and
          the measurement that decided it. This is the single highest-signal file in most
        ...
        <li>
          ...
          with real messages reads as a project. One commit named{" "}
          <code>final version</code> reads as a download.
        </li>
      </ol>
      ...
      <p>
        ...
        postings for the role you want, list every responsibility that appears in three or more
        of them, and choose projects that produce evidence for the top two. That list is
        usually shorter and more boring than expected: deployment, evaluation, data quality,
        and being able to explain a tradeoff.
      </p>

      <p>
        Then give each project a scope you can finish. A project abandoned at 70% is worth less
        than nothing, because the repo is public and the abandonment is visible. Six to eight
        weeks per project, two or three projects, is a realistic six months.
      </p>
