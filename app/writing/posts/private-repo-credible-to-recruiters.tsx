...
import { Figure, NdaWall } from "../Figure"
    ...
    <>
      <Lede label="The bind">
        <p>
          ...
          to an employer, sits under an NDA, or is a startup you have not launched yet. The
          usual advice, &ldquo;just make it public&rdquo;, is not advice, and the usual
          fallback, writing a paragraph on your resume and hoping, converts badly. An
          unverifiable claim in a competitive pile is treated as a decorative one.
        </p>
      ...
      <Section title="The artefacts" label="Six of them">
        <Figure caption="Nothing on the left has to move for the project to become verifiable. Everything on the right is publishable with light redaction.">
          <NdaWall />
        </Figure>
        ...
        <p>
          ...
          application. Problem, constraints, architecture, decisions, outcome. Not a landing
          page and not a pitch: it should read like an internal write-up that happens to be
          public.
        </p>
        <p>
          This site does exactly that. The{" "}
          <Link href="/">case studies linked from the projects section</Link> are built so that
          a reader who cannot see the repo still leaves with a specific, checkable picture of
          what was built.
        </p>
        ...
        <p>
          ...
          private project, the method statement <em>is</em> the proof, because there is no repo
          to fall back on.
        </p>
        ...
        <p>
          If even the interface is sensitive, record a CLI or the API responses. Behaviour is
          the point; polish is not.
        </p>
      ...
      <Section title="What travels" label="Extract early">
        <p>
      ...
      <Section title="The anchor" label="Keep one public">
        <p>
          ...
          engineering discipline: real commit history, tests, CI, a benchmark output. It does
          not need to be your most impressive system. It needs to make the private claims
          plausible by showing how you work when someone can watch.
        </p>

        <p>
          On this site that role is played by a couple of public repos alongside the private
          case studies, on purpose. The public ones are not the most interesting work; they are
          the proof that the write-ups describe something real.
        </p>
