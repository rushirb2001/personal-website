...
export default function Post() {
  return (
    <>
      <p>
        &ldquo;I cannot afford the compute&rdquo; is the most common reason people give for not
        having a portfolio, and it is almost never the real constraint. Between hosted
      ...
      <p>
        What does cost you is picking the wrong tier for the workload and discovering the limit
        in week four. So this is organised by the limit, not by the marketing.
      </p>

      <p className="callout">
        Every quota below moves, sometimes without an announcement. Treat these as the shape of
        each tier, then check the provider before you design around a number.
      </p>

      <h2>Inference: hosted APIs, not your own GPU</h2>
      ...
      <h3>Gemini API</h3>
      <p>
        A free tier covering both generation and embeddings, which matters more than it sounds:
        embedding a corpus is usually the first thing that would have cost you money.{" "}
      ...
      <h2>GPU: Colab, for training only</h2>
      ...
      <ul>
        ...
        <li>
          Log metrics to something external (Weights and Biases has a free personal tier), or a
          disconnect takes your results with it.
        </li>
        <li>
      ...
      <p>
        <strong>Breaks at:</strong> two things. A modest storage ceiling, which is generous for
        text and immediately tight if you store raw files (put those in object storage and
      ...
      <h2>The always-on server: Oracle Cloud, with a caveat</h2>
      ...
      <p>
        ...
        for anything that has to stay up: a scheduled pipeline, a webhook receiver, a demo API.
      </p>

      <p>
        <strong>The caveat, and it is recent:</strong> in June 2026 Oracle halved the Always
        Free Ampere A1 allowance from 4 OCPUs and 24 GB of RAM to 2 OCPUs and 12 GB, with no
        announcement. Plenty of guides still quote the old figures. Two cores and 12 GB is
        still a real server and still more than most portfolio projects need, but if you
        planned a workload around 24 GB you should replan now rather than at deploy time.
      </p>

      <p>
        <strong>Also breaks at:</strong> capacity. A1 instances are frequently unavailable in
        the busiest regions, sometimes for days. Pick a quieter home region when you create the
        tenancy, because changing it later is painful.
      </p>

      <h2>The pieces people forget</h2>
      ...
      <ul>
        ...
        <li>
          <strong>Frontend hosting:</strong> a hobby tier is enough for a demo and a
          case-study page. This site runs on one.
        </li>
        <li>
      ...
      <h2>What free tiers cannot do</h2>

      <p>
        Being straight about the ceiling, because designing past it wastes months:
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          a sampled dataset, with the scaling argument written down. That is the honest version
          and it interviews well.
        </li>
