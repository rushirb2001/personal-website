...
const WORK = [
  {
    ...
    period: "2025 – Present",
    desc: "Medical AI for India's surgical trainees: a RAG backend over surgical textbooks, an edge gateway for auth and quota, and web and iOS clients that stream cited answers. Live in production.",
    descShort: "Medical AI for India's surgical trainees: RAG backend, edge gateway, web and iOS clients.",
    ...
    <main className="min-h-screen bg-[#f4f1ec] text-[#1a1a1a]">
      <style>{`
        ...
        @media (max-width: 639px) {
          ...
          /* Open-section content rides the same curve (caps hit near 850svh
        ...
        >
          ...
          <div className="grid grid-cols-1 xs:grid-cols-[clamp(80px,14vw,140px)_1fr_clamp(140px,22vw,240px)] lg:grid-cols-[140px_1fr_240px] gap-3 xs:gap-6 lg:gap-12 py-5 xs:py-8 lg:py-10 pt-3 xs:pt-4 lg:pt-6">
            ...
            <div>
              ...
              {/* The only in-content links off this page. Descriptive anchors
                  on purpose: this is the highest-authority page on the site, so
                  what it says about /writing and /playbook is what those two
                  routes get judged on. */}
              <p className="mt-3 xs:mt-4 leading-relaxed text-[14px] xs:text-[15px] mono muted">
                I also write about{" "}
                <Link href="/writing" className="accent-link accent">
                  building an AI engineering portfolio
                </Link>
                , and packaged the whole method as{" "}
                <Link href="/playbook" className="accent-link accent">
                  Zero to Hired
                </Link>
                .
              </p>
